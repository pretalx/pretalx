...
setup(
    ...
    install_requires=[
        ...
        "bleach~=3.2.0",  # https://bleach.readthedocs.io/en/latest/changes.html
        ...
        "requests>=2.24,<2.26",  # https://2.python-requests.org/en/master/community/updates/#release-and-version-history
