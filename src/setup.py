...
setup(
    ...
    install_requires=[
        "beautifulsoup4==4.9.*",  # https://bazaar.launchpad.net/~leonardr/beautifulsoup/bs4/view/head:/CHANGELOG
        ...
        "Django>=3.0,<3.2",  # https://docs.djangoproject.com/en/2.0/releases/
        "django-bootstrap4==2.0.*",  # http://django-bootstrap4.readthedocs.io/en/latest/history.html
        "django-compressor==2.4.*",  # https://django-compressor.readthedocs.io/en/latest/changelog/
        "django-context-decorator",
        "django-countries==6.1.*",  # https://github.com/SmileyChris/django-countries/blob/master/CHANGES.rst
        "django-csp==3.6.*",  # https://github.com/mozilla/django-csp/blob/master/CHANGES
        "django-filter==2.3.*",  # https://github.com/carltongibson/django-filter/blob/master/CHANGES.rst
        ...
        "django-i18nfield==1.8.*",  # 2020-06, no changelog, https://github.com/raphaelm/django-i18nfield/
        ...
        "whitenoise==5.1.*",  # http://whitenoise.evans.io/en/stable/changelog.html
    ...
    extras_require={
        ...
        "redis": ["django_redis==4.12.*", "redis==3.5.*",],
    },
