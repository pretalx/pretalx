...
setup(
    ...
    install_requires=[
        ...
        "Django>=3.2,<4.3",  # https://docs.djangoproject.com/en/dev/releases/
        ...
        "requests~=2.29.0",  # https://2.python-requests.org/en/master/community/updates/#release-and-version-history
