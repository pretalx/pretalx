...
setup(
    ...
    install_requires=[
        "beautifulsoup4~=4.11.0",  # https://bazaar.launchpad.net/~leonardr/beautifulsoup/bs4/view/head:/CHANGELOG
        ...
        "django-bootstrap4>=3.0,<22.4",  # http://django-bootstrap4.readthedocs.io/en/latest/history.html
