...
setup(
    ...
    install_requires=[
        ...
        "django-compressor>=4.3,<4.5",  # https://django-compressor.readthedocs.io/en/latest/changelog/
        ...
        "qrcode~=7.0",
        "reportlab~=4.0.0",  # https://www.reportlab.com/documentation/relnotes/
        ...
        "whitenoise~=6.5.0",  # http://whitenoise.evans.io/en/stable/changelog.html
