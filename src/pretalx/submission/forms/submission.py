...
from pretalx.common.mixins.forms import CustomiseHelpText, MarkdownHelp, PublicContent, RequestRequire
from pretalx.submission.models import Submission, SubmissionStates


class InfoForm(MarkdownHelp, RequestRequire, PublicContent, CustomiseHelpText, forms.ModelForm):
    ...
    class Meta:
        ...
        markdown_fields = ['abstract', 'description', 'notes']
