...
NEW_SUBMISSION_TEXT = LazyI18nString.from_gettext(_("""Hi,
...
NEW_SPEAKER_INVITE_TEXT = LazyI18nString.from_gettext(_("""Hi!
...
The {event} orga crew"""))
EXISTING_SPEAKER_INVITE_TEXT = LazyI18nString.from_gettext(_("""Hi!
