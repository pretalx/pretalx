...
urlpatterns = [
    ...
    path("verify/", auth.VerificationView.as_view(), name="auth.verification"),
    path("verify/<token>", auth.VerifyView.as_view(), name="auth.verify"),
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "verify/<token>",
                    auth.VerifyView.as_view(),
                    name="event.auth.verify",
                ),
