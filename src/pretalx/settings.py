...
LANGUAGES = [("en", _("English")), ("de", _("German")), ("fr", _("French")), ("zh_TW", _("Traditional Chinese (Taiwan)"))]
LANGUAGES_NATURAL_NAMES = [("en", "English"), ("de", "Deutsch"), ("fr", "Français"), ("zh_TW", "Traditional Chinese (Taiwan)")]
LANGUAGES_OFFICIAL = {"en", "de", "zh_TW"}
