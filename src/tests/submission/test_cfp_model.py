...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            datetime(year=2000, month=10, day=20),
            [datetime(year=2000, month=11, day=20)],
            False,
        ),  # CfP deadline past with past other deadlines
        (
            datetime(year=2000, month=10, day=20),
            [datetime(year=2000, month=11, day=20), datetime(2200, month=10, day=20)],
            True,
        ),  # CfP deadline past with past and future other deadlines
        (datetime(year=2200, month=10, day=20), [], True),  # CfP deadline future
        (
            datetime(year=2200, month=10, day=20),
            [datetime(year=2000, month=11, day=20)],
            True,
