...
@pytest.mark.parametrize(
    ...
    (
        (
            # real overlap
            Availability(
                start=datetime.datetime(2017, 1, 1, 4),
                end=datetime.datetime(2017, 1, 1, 7),
            ),
            Availability(
                start=datetime.datetime(2017, 1, 1, 5),
                end=datetime.datetime(2017, 1, 1, 9),
            ),
            Availability(
                start=datetime.datetime(2017, 1, 1, 4),
                end=datetime.datetime(2017, 1, 1, 9),
        ...
        (
            ...
            Availability(
                start=datetime.datetime(2017, 1, 1, 7),
                end=datetime.datetime(2017, 1, 1, 8),
            ),
            Availability(
                start=datetime.datetime(2017, 1, 1, 4),
                end=datetime.datetime(2017, 1, 1, 8),
...
def test_availability_fail(method, args, expected):
    avail = Availability(
        start=datetime.datetime(2017, 1, 1), end=datetime.datetime(2017, 1, 1, 1)
    )
    ...
    (
        ...
        (
            [
                ...
                Availability(
                    start=datetime.datetime(2017, 1, 1, 6),
                    end=datetime.datetime(2017, 1, 1, 7),
                ),
            ],
            [
        ...
        (
            [
                ...
                Availability(
                    start=datetime.datetime(2017, 1, 1, 5),
                    end=datetime.datetime(2017, 1, 1, 6),
                ),
            ],
            [
                Availability(
        ...
        (
            [
                ...
                Availability(
                    start=datetime.datetime(2017, 1, 1, 12),
                    end=datetime.datetime(2017, 1, 1, 14),
                ),
                Availability(
                    start=datetime.datetime(2017, 1, 1, 5),
                    end=datetime.datetime(2017, 1, 1, 7),
                ...
                Availability(
                    start=datetime.datetime(2017, 1, 1, 18),
                    end=datetime.datetime(2017, 1, 1, 19),
                ),
                Availability(
                    start=datetime.datetime(2017, 1, 1, 4),
                    end=datetime.datetime(2017, 1, 1, 6),
    ...
    (
        ...
        (
            ...
            [
                [
                    Availability(
                        start=datetime.datetime(2017, 1, 1, 2),
                        end=datetime.datetime(2017, 1, 1, 7),
                    )
                ],
                [
                    Availability(
                        ...
                        end=datetime.datetime(2017, 1, 1, 3),
                    ),
                    Availability(
                        start=datetime.datetime(2017, 1, 1, 6),
                        end=datetime.datetime(2017, 1, 1, 8),
        ...
        (
            ...
            [
                ...
                [
                    Availability(
                        start=datetime.datetime(2017, 1, 1, 9),
                        end=datetime.datetime(2017, 1, 1, 7),
                    )
                ],
            ],
        ...
        (
            ...
            [
                ...
                [
                    ...
                    Availability(
                        start=datetime.datetime(2017, 1, 1, 3),
                        end=datetime.datetime(2017, 1, 1, 4),
                    ),
                ],
            ],
            [
        ...
        (
            ...
            [
                [
                    ...
                    Availability(
                        start=datetime.datetime(2017, 1, 1, 14),
                        end=datetime.datetime(2017, 1, 1, 19),
                    ),
                ],
                [
                    ...
                    Availability(
                        start=datetime.datetime(2017, 1, 1, 13),
                        end=datetime.datetime(2017, 1, 1, 15),
                    ),
                ],
            ],
            [
...
def test_equality(event):
    avail = (
        Availability(
            start=datetime.datetime(2017, 1, 1, 5), end=datetime.datetime(2017, 1, 1, 7)
        ),
    )
    avail2 = (
        Availability(
