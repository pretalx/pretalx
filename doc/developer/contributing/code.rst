...
other objects to get set up. Do **not** use fixtures to wrap a single factory
call — call the factory directly in the test instead. Reserve ``conftest.py``
fixtures for setups that involve multiple objects, relationships, or teardown
